...
public class Swerve extends SubsystemBase {
  ...
  public ChassisSpeeds getRobotRelativeSpeeds() {
    return Constants.kSwerve.KINEMATICS.toChassisSpeeds(getStates());
  }

  public void driveRobotRelative(ChassisSpeeds robotRelativeSpeeds) {
    ChassisSpeeds targetSpeeds = ChassisSpeeds.discretize(robotRelativeSpeeds, 0.02);

    SwerveModuleState[] targetStates = Constants.kSwerve.KINEMATICS.toSwerveModuleStates(targetSpeeds);
  ...
  public Swerve() {
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your
            ...
            0.443, // Drive base radius in meters. Distance from robot center to furthest module.
   ...
   */
  public Command drive(DoubleSupplier forwardBackAxis, DoubleSupplier leftRightAxis, DoubleSupplier rotationAxis,
  ...
  public void forceZeroGyro() {
    Pose2d a = new Pose2d();
    swerveOdometry.resetPosition(Rotation2d.fromDegrees(0), getPositions(), a);
  }
